...
window.onload = () => {
    ...
    function createRows(objects) {
        for (let i=0; i < objects.length; i++) {
            ...
            mass.innerHTML = Math.round(objects[i].body.mass);
            ...
            var forceButton = row.insertCell(11);
            var btn = document.createElement("BUTTON");
            btn.innerHTML = 'Apply Force';
            btn.className += 'btn btn-primary btn-rounded btn-sm my-0';
            btn.value = i;
    ...
    // // Objects attract to this circle
    // var body = Matter.Bodies.circle(100, 100, 50, {
    //   collisionFilter: {
    //             category: defaultCategory},
    //   plugin: {
    //     attractors: [
    ...
    function createMouse(render, simulatorContainer) {
